...
export const WIDGET_CATALOG = [
  ...
  { id: 'total-cards', title: '현재 도전/기록', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 3, h: 2 }, minSize: { w: 2, h: 2 }, maxSize: { w: 3, h: 3 }, kind: 'recordRoomKpi' },
  { id: 'hall-count', title: '명예의 전당', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 3, h: 2 }, minSize: { w: 2, h: 2 }, maxSize: { w: 3, h: 3 }, kind: 'recordRoomKpi' },
  { id: 'stars', title: '별 갯수', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 3, h: 2 }, minSize: { w: 2, h: 2 }, maxSize: { w: 3, h: 3 }, kind: 'recordRoomKpi' },
  { id: 'today-count', title: '오늘 기록', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 3, h: 2 }, minSize: { w: 2, h: 2 }, maxSize: { w: 3, h: 3 }, kind: 'recordRoomKpi' },
  { id: 'deleted-count', title: '삭제 갯수', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 3, h: 2 }, minSize: { w: 2, h: 2 }, maxSize: { w: 3, h: 3 }, kind: 'recordRoomKpi' },
  { id: 'expired-fail', title: '만료 실패', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 3, h: 2 }, minSize: { w: 2, h: 2 }, maxSize: { w: 3, h: 3 }, kind: 'recordRoomKpi' },

  { id: 'weekly-bars', title: '주간 막대', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 6, h: 4 }, minSize: { w: 4, h: 4 }, maxSize: { w: 6, h: 6 }, kind: 'recordRoomChart' },
  { id: 'ratio-donut', title: '도전/기록 비율', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 3, h: 4 }, minSize: { w: 3, h: 4 }, maxSize: { w: 6, h: 5 }, kind: 'recordRoomChart' },
  { id: 'token-line', title: '토큰 추이', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 3, h: 4 }, minSize: { w: 3, h: 4 }, maxSize: { w: 6, h: 5 }, kind: 'recordRoomChart' },
  { id: 'calendar', title: '인증 달력', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 6, h: 5 }, minSize: { w: 4, h: 5 }, maxSize: { w: 6, h: 7 }, kind: 'recordRoomChart' },
  { id: 'heatmap', title: '인증 시간 패턴', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 6, h: 5 }, minSize: { w: 4, h: 5 }, maxSize: { w: 6, h: 7 }, kind: 'recordRoomChart' },
  { id: 'monthly-bars', title: '월간 기록', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 6, h: 4 }, minSize: { w: 4, h: 4 }, maxSize: { w: 6, h: 6 }, kind: 'recordRoomChart' },

  { id: 'hall-battery', title: '명예의 전당 목표', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 6, h: 3 }, minSize: { w: 4, h: 3 }, maxSize: { w: 6, h: 5 }, kind: 'recordRoom' },
  { id: 'connect-status', title: '커넥트 상태', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 6, h: 3 }, minSize: { w: 4, h: 3 }, maxSize: { w: 6, h: 4 }, kind: 'recordRoom' },
  { id: 'memo', title: '메모', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 6, h: 3 }, minSize: { w: 4, h: 3 }, maxSize: { w: 6, h: 5 }, kind: 'recordRoom' },
  { id: 'record-room-card-list', title: '내 기록실 카드목록', tier: 0, price: 0, shop: false, defaultOwned: true, supports: ['recordRoom'], defaultSize: { w: 6, h: 6 }, minSize: { w: 6, h: 5 }, maxSize: { w: 6, h: 10 }, kind: 'recordRoomList' },
];
