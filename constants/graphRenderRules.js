...
/**
 * DONUT family canonical standard primitives.
 *
 * 아래 3개 객체가 DONUT family의 색상 슬롯, 레이아웃,
 * 내부 색상 연결에 대한 실제 단일 원본이다.
 * 기존 OVERALL_PROGRESS render family는 호환 adapter로
 * 같은 객체를 참조한다.
 */
export const GRAPH_DONUT_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
...
export const GRAPH_DONUT_STANDARD_LAYOUT = Object.freeze({
 bodyBaseHeight: 146,
 baseSize: 104,
 baseStroke: 11,
 minScale: 0.75,
...
export const GRAPH_DONUT_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
...
/**
 * BAR family canonical standard primitives.
 *
 * BAR family는 weekly, progress, metric, stacked 네 가지 시각 구조를 가진다.
 * 아래 객체들이 색상 슬롯, 레이아웃, 내부 색상 연결의 실제 단일 원본이다.
 * 기존 기술 family는 저장값 호환 adapter로 같은 객체를 참조한다.
 */

export const GRAPH_BAR_WEEKLY_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
...
export const GRAPH_BAR_WEEKLY_STANDARD_LAYOUT = Object.freeze({
  baseViewHeight: 168,
...
export const GRAPH_BAR_WEEKLY_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
...
export const GRAPH_BAR_PROGRESS_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
...
export const GRAPH_BAR_PROGRESS_STANDARD_LAYOUT = Object.freeze({
  bodyBaseHeight: 96,
  valueFontSize: 28,
  captionFontSize: 10,
  barHeight: 6,
...
export const GRAPH_BAR_PROGRESS_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
...
export const GRAPH_BAR_METRIC_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
...
export const GRAPH_BAR_METRIC_STANDARD_LAYOUT = Object.freeze({
  bodyBaseHeight: 120,
  chartMinHeight: 40,
...
export const GRAPH_BAR_METRIC_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
  barFill: 'barFill',
...
export const GRAPH_BAR_STACKED_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
  trackFill: Object.freeze({
    label: '전체 배경',
...
export const GRAPH_BAR_STACKED_STANDARD_LAYOUT = Object.freeze({
  bodyBaseHeight: 96,
  segmentHeight: 18,
  segmentRadius: 9,
  labelGap: 8,
...
export const GRAPH_BAR_STACKED_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
  trackFill: 'trackFill',
...
/**
 * LINE family canonical standard primitives.
 *
 * 아래 객체들이 LINE 그래프의 색상 슬롯, 레이아웃,
 * 내부 색상 연결에 대한 실제 단일 원본이다.
 * 기존 LINE render 경로도 같은 객체를 참조한다.
 */

export const GRAPH_LINE_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
  line: Object.freeze({
    label: '선',
    defaultRole: 'primary',
...
export const GRAPH_LINE_STANDARD_LAYOUT = Object.freeze({
  defaultHeight: 185,
...
export const GRAPH_LINE_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
  lineStroke: 'line',
  axisStroke: 'axis',
  labelText: 'text',
  markerFill: 'surface',
...
/**
 * INFO_CARD family canonical standard primitives.
 *
 * 아래 3개 객체가 INFO_CARD family의 색상 슬롯, 레이아웃,
 * 내부 색상 연결에 대한 실제 단일 원본이다.
 * 기존 INFO_CARD render family는 호환 adapter로
 * 같은 객체를 참조한다.
 */
export const GRAPH_INFO_CARD_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
...
export const GRAPH_INFO_CARD_STANDARD_LAYOUT = Object.freeze({
  bodyBaseHeight: 72,
  titleFontSize: 13,
  bodyFontSize: 12,
  captionFontSize: 10,
...
export const GRAPH_INFO_CARD_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
  titleText: 'titleText',
  bodyText: 'bodyText',
  captionText: 'captionText',
...
/**
 * CALENDAR family canonical standard primitives.
 *
 * 아래 객체들이 CALENDAR 그래프의 색상 슬롯, 레이아웃,
 * 내부 색상 연결에 대한 실제 단일 원본이다.
 * 기존 CALENDAR render 경로도 같은 객체를 참조한다.
 */
export const GRAPH_CALENDAR_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
...
export const GRAPH_CALENDAR_STANDARD_LAYOUT = Object.freeze({
  bodyBaseHeight: 142,
  dowHeight: 14,
  dowFontSize: 10.5,
  gridTopGap: 3,
...
export const GRAPH_CALENDAR_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
...
/**
 * GRASS family canonical standard primitives.
 *
 * 아래 객체들이 GRASS 그래프의 색상 슬롯, 레이아웃,
 * 내부 색상 연결에 대한 실제 단일 원본이다.
 * 기존 GRASS render 경로도 같은 객체를 참조한다.
 */
export const GRAPH_GRASS_STANDARD_EDITABLE_COLOR_SLOTS = Object.freeze({
...
export const GRAPH_GRASS_STANDARD_LAYOUT = Object.freeze({
  baseHeight: 168,
  rows: 7,
  topLabelHeight: 18,
  topLabelGap: 4,
...
export const GRAPH_GRASS_STANDARD_INTERNAL_COLOR_MAP = Object.freeze({
  level0: 'level0',
  level1: 'level1',
  level2: 'level2',
  level3: 'level3',
...
export const GRAPH_RENDER_EDITABLE_COLOR_SLOTS = Object.freeze({
  [GRAPH_RENDER_FAMILIES.OVERALL_PROGRESS]:
    GRAPH_DONUT_STANDARD_EDITABLE_COLOR_SLOTS,

  [GRAPH_RENDER_FAMILIES.CALENDAR]:
    GRAPH_CALENDAR_STANDARD_EDITABLE_COLOR_SLOTS,

  [GRAPH_RENDER_FAMILIES.WEEKLY_BAR]:
    GRAPH_BAR_WEEKLY_STANDARD_EDITABLE_COLOR_SLOTS,

  [GRAPH_RENDER_FAMILIES.LINE]:
    GRAPH_LINE_STANDARD_EDITABLE_COLOR_SLOTS,

  [GRAPH_RENDER_FAMILIES.GRASS]:
    GRAPH_GRASS_STANDARD_EDITABLE_COLOR_SLOTS,

  [GRAPH_RENDER_FAMILIES.PROGRESS_BAR]:
    GRAPH_BAR_PROGRESS_STANDARD_EDITABLE_COLOR_SLOTS,

  [GRAPH_RENDER_FAMILIES.METRIC_BAR]:
    GRAPH_BAR_METRIC_STANDARD_EDITABLE_COLOR_SLOTS,

  [GRAPH_RENDER_FAMILIES.STACKED_SEGMENT]:
    GRAPH_BAR_STACKED_STANDARD_EDITABLE_COLOR_SLOTS,

  [GRAPH_RENDER_FAMILIES.INFO_CARD]:
    GRAPH_INFO_CARD_STANDARD_EDITABLE_COLOR_SLOTS,
});

export const GRAPH_RENDER_LAYOUT_RULES = Object.freeze({
  [GRAPH_RENDER_FAMILIES.OVERALL_PROGRESS]:
    GRAPH_DONUT_STANDARD_LAYOUT,

  [GRAPH_RENDER_FAMILIES.CALENDAR]:
    GRAPH_CALENDAR_STANDARD_LAYOUT,

  [GRAPH_RENDER_FAMILIES.WEEKLY_BAR]:
    GRAPH_BAR_WEEKLY_STANDARD_LAYOUT,

  [GRAPH_RENDER_FAMILIES.LINE]:
    GRAPH_LINE_STANDARD_LAYOUT,

  [GRAPH_RENDER_FAMILIES.GRASS]:
    GRAPH_GRASS_STANDARD_LAYOUT,

  [GRAPH_RENDER_FAMILIES.PROGRESS_BAR]:
    GRAPH_BAR_PROGRESS_STANDARD_LAYOUT,

  [GRAPH_RENDER_FAMILIES.METRIC_BAR]:
    GRAPH_BAR_METRIC_STANDARD_LAYOUT,

  [GRAPH_RENDER_FAMILIES.STACKED_SEGMENT]:
    GRAPH_BAR_STACKED_STANDARD_LAYOUT,

  [GRAPH_RENDER_FAMILIES.INFO_CARD]:
    GRAPH_INFO_CARD_STANDARD_LAYOUT,
});

export const GRAPH_RENDER_INTERNAL_COLOR_MAP = Object.freeze({
  [GRAPH_RENDER_FAMILIES.OVERALL_PROGRESS]:
    GRAPH_DONUT_STANDARD_INTERNAL_COLOR_MAP,

  [GRAPH_RENDER_FAMILIES.CALENDAR]:
    GRAPH_CALENDAR_STANDARD_INTERNAL_COLOR_MAP,

  [GRAPH_RENDER_FAMILIES.WEEKLY_BAR]:
    GRAPH_BAR_WEEKLY_STANDARD_INTERNAL_COLOR_MAP,

  [GRAPH_RENDER_FAMILIES.LINE]:
    GRAPH_LINE_STANDARD_INTERNAL_COLOR_MAP,

  [GRAPH_RENDER_FAMILIES.GRASS]:
    GRAPH_GRASS_STANDARD_INTERNAL_COLOR_MAP,

  [GRAPH_RENDER_FAMILIES.PROGRESS_BAR]:
    GRAPH_BAR_PROGRESS_STANDARD_INTERNAL_COLOR_MAP,

  [GRAPH_RENDER_FAMILIES.METRIC_BAR]:
    GRAPH_BAR_METRIC_STANDARD_INTERNAL_COLOR_MAP,

  [GRAPH_RENDER_FAMILIES.STACKED_SEGMENT]:
    GRAPH_BAR_STACKED_STANDARD_INTERNAL_COLOR_MAP,

  [GRAPH_RENDER_FAMILIES.INFO_CARD]:
    GRAPH_INFO_CARD_STANDARD_INTERNAL_COLOR_MAP,
});
...
export const GRAPH_BAR_VARIANT_STANDARDS = Object.freeze({
  [GRAPH_VARIANTS.BAR_WEEKLY]: Object.freeze({
   canonical: true,
   ...
   graphIds: Object.freeze([GRAPH_RENDER_GRAPH_IDS.WEEKLY_BAR]),
   geometry: 'weeklyVerticalBars',
   dataShape: 'sevenDayChallengeSummary',
   interaction: 'pagedWeekNavigation',
   allowedElements: Object.freeze(['data', 'title', 'unit', 'dateLabels', 'dayLabels', 'currentDayEmphasis', 'pager', 'valueFormat', 'auxiliaryElements']),
   forbiddenOverrides: GRAPH_BAR_VARIANT_FORBIDDEN_OVERRIDE_KEYS,
   editableColorSlots:
    GRAPH_RENDER_EDITABLE_COLOR_SLOTS[GRAPH_RENDER_FAMILIES.WEEKLY_BAR],
   layout:
    GRAPH_RENDER_LAYOUT_RULES[GRAPH_RENDER_FAMILIES.WEEKLY_BAR],
   internalColorMap:
    GRAPH_RENDER_INTERNAL_COLOR_MAP[GRAPH_RENDER_FAMILIES.WEEKLY_BAR],
   connectionStatus: 'connected',
   sourceOfTruth:
    'GRAPH_FAMILY_STANDARDS.bar.variantStandards',
  }),

  [GRAPH_VARIANTS.BAR_WEEKLY_STEPS]: Object.freeze({
   canonical: true,
   version: GRAPH_BAR_VARIANT_STANDARD_VERSION,
   family: GRAPH_FAMILIES.BAR,
   variant: GRAPH_VARIANTS.BAR_WEEKLY_STEPS,
   ...
   inheritsFamilyStandard: GRAPH_FAMILIES.BAR,
   legacyRenderFamily: GRAPH_RENDER_FAMILIES.WEEKLY_BAR,
   graphIds: Object.freeze([GRAPH_RENDER_GRAPH_IDS.HEALTH_STEPS_WEEKLY]),
   geometry: 'weeklyVerticalBarsWithGoalLine',
   dataShape: 'sevenDayHealthStepSummary',
   interaction: 'singleWeekDisplay',
   allowedElements: Object.freeze(['data', 'title', 'unit', 'dateLabels', 'dayLabels', 'currentDayEmphasis', 'goalLine', 'goalLabel', 'valueFormat', 'auxiliaryElements']),
   forbiddenOverrides: GRAPH_BAR_VARIANT_FORBIDDEN_OVERRIDE_KEYS,
   editableColorSlots:
    GRAPH_RENDER_EDITABLE_COLOR_SLOTS[GRAPH_RENDER_FAMILIES.WEEKLY_BAR],
   layout:
  ...
  [GRAPH_VARIANTS.BAR_PROGRESS]: Object.freeze({
   canonical: true,
   version: GRAPH_BAR_VARIANT_STANDARD_VERSION,
   family: GRAPH_FAMILIES.BAR,
   variant: GRAPH_VARIANTS.BAR_PROGRESS,
   ...
   graphIds: Object.freeze([GRAPH_RENDER_GRAPH_IDS.HEALTH_STEPS_GOAL_RATE]),
   geometry: 'singleHorizontalProgressBar',
   dataShape: 'currentValueAndGoalRatio',
   interaction: 'displayOnly',
   allowedElements: Object.freeze(['data', 'title', 'unit', 'goalValue', 'valueFormat', 'successState', 'caption', 'emptyState', 'auxiliaryElements']),
   forbiddenOverrides: GRAPH_BAR_VARIANT_FORBIDDEN_OVERRIDE_KEYS,
   editableColorSlots:
    GRAPH_RENDER_EDITABLE_COLOR_SLOTS[GRAPH_RENDER_FAMILIES.PROGRESS_BAR],
   layout:
    GRAPH_RENDER_LAYOUT_RULES[GRAPH_RENDER_FAMILIES.PROGRESS_BAR],
   internalColorMap:
    GRAPH_RENDER_INTERNAL_COLOR_MAP[GRAPH_RENDER_FAMILIES.PROGRESS_BAR],
   connectionStatus: 'connected',
   sourceOfTruth:
    'GRAPH_FAMILY_STANDARDS.bar.variantStandards',
  }),

  [GRAPH_VARIANTS.BAR_METRIC_WEEKLY]: Object.freeze({
   canonical: true,
   version: GRAPH_BAR_VARIANT_STANDARD_VERSION,
   family: GRAPH_FAMILIES.BAR,
   variant: GRAPH_VARIANTS.BAR_METRIC_WEEKLY,
   ...
   graphIds: Object.freeze([GRAPH_RENDER_GRAPH_IDS.HEALTH_EXERCISE_WEEKLY_MINUTES,GRAPH_RENDER_GRAPH_IDS.HEALTH_DISTANCE_WEEKLY]),
   geometry: 'weeklyMetricBars',
   dataShape: 'periodMetricValues',
   interaction: 'displayOnly',
   allowedElements: Object.freeze(['data', 'title', 'unit', 'period', 'valueFormat', 'latestEmphasis', 'goalLine', 'caption', 'emptyState', 'auxiliaryElements']),
   forbiddenOverrides: GRAPH_BAR_VARIANT_FORBIDDEN_OVERRIDE_KEYS,
   editableColorSlots:
    GRAPH_RENDER_EDITABLE_COLOR_SLOTS[GRAPH_RENDER_FAMILIES.METRIC_BAR],
   layout:
    GRAPH_RENDER_LAYOUT_RULES[GRAPH_RENDER_FAMILIES.METRIC_BAR],
   internalColorMap:
    GRAPH_RENDER_INTERNAL_COLOR_MAP[GRAPH_RENDER_FAMILIES.METRIC_BAR],
   connectionStatus: 'connected',
   sourceOfTruth:
    'GRAPH_FAMILY_STANDARDS.bar.variantStandards',
  }),

  [GRAPH_VARIANTS.BAR_METRIC_CUMULATIVE]: Object.freeze({
   canonical: true,
   version: GRAPH_BAR_VARIANT_STANDARD_VERSION,
   family: GRAPH_FAMILIES.BAR,
   variant: GRAPH_VARIANTS.BAR_METRIC_CUMULATIVE,
   ...
   inheritsFamilyStandard: GRAPH_FAMILIES.BAR,
   legacyRenderFamily: GRAPH_RENDER_FAMILIES.METRIC_BAR,
   graphIds: Object.freeze([GRAPH_RENDER_GRAPH_IDS.HEALTH_STEPS_CUMULATIVE,GRAPH_RENDER_GRAPH_IDS.HEALTH_DISTANCE_CUMULATIVE]),
   geometry: 'cumulativeMetricBars',
   dataShape: 'cumulativeMetricValues',
   interaction: 'displayOnly',
   allowedElements: Object.freeze(['data', 'title', 'unit', 'cumulative', 'valueFormat', 'latestEmphasis', 'goalLine', 'caption', 'emptyState', 'auxiliaryElements']),
   forbiddenOverrides: GRAPH_BAR_VARIANT_FORBIDDEN_OVERRIDE_KEYS,
   editableColorSlots:
    GRAPH_RENDER_EDITABLE_COLOR_SLOTS[GRAPH_RENDER_FAMILIES.METRIC_BAR],
   layout:
  ...
  [GRAPH_VARIANTS.BAR_STACKED]: Object.freeze({
   canonical: true,
   version: GRAPH_BAR_VARIANT_STANDARD_VERSION,
   family: GRAPH_FAMILIES.BAR,
   variant: GRAPH_VARIANTS.BAR_STACKED,
   ...
   graphIds: Object.freeze([GRAPH_RENDER_GRAPH_IDS.HEALTH_SLEEP_RHYTHM]),
   geometry: 'stackedSegmentBar',
   dataShape: 'labeledSegmentRatios',
   interaction: 'displayOnly',
   allowedElements: Object.freeze(['data', 'title', 'unit', 'segments', 'legend', 'valueFormat', 'caption', 'emptyState', 'auxiliaryElements']),
   forbiddenOverrides: GRAPH_BAR_VARIANT_FORBIDDEN_OVERRIDE_KEYS,
   editableColorSlots:
    GRAPH_RENDER_EDITABLE_COLOR_SLOTS[GRAPH_RENDER_FAMILIES.STACKED_SEGMENT],
   layout:
    GRAPH_RENDER_LAYOUT_RULES[GRAPH_RENDER_FAMILIES.STACKED_SEGMENT],
   internalColorMap:
    GRAPH_RENDER_INTERNAL_COLOR_MAP[GRAPH_RENDER_FAMILIES.STACKED_SEGMENT],
   connectionStatus: 'connected',
   sourceOfTruth:
    'GRAPH_FAMILY_STANDARDS.bar.variantStandards',
  }),
...
export const GRAPH_DONUT_FAMILY_STANDARD = Object.freeze({
 version: GRAPH_FAMILY_STANDARD_VERSION,
 family: GRAPH_FAMILIES.DONUT,

 // 저장된 기존 byFamily.overallProgress 색상 설정을 읽기 위한
 // 호환 식별자일 뿐, 시각 규칙의 source는 아래 canonical 객체이다.
 legacyRenderFamily: GRAPH_RENDER_FAMILIES.OVERALL_PROGRESS,

 referenceGraphId:
  GRAPH_FAMILY_REFERENCE_GRAPH_ID_BY_FAMILY[GRAPH_FAMILIES.DONUT],
 ...
 sourceOfTruth: 'GRAPH_DONUT_FAMILY_STANDARD',
 canonical: true,
});


export const GRAPH_BAR_FAMILY_STANDARD = Object.freeze({
  version: GRAPH_FAMILY_STANDARD_VERSION,
  family: GRAPH_FAMILIES.BAR,
  legacyRenderFamily: GRAPH_RENDER_FAMILIES.WEEKLY_BAR,
  referenceGraphId:
    GRAPH_FAMILY_REFERENCE_GRAPH_ID_BY_FAMILY[GRAPH_FAMILIES.BAR],
  geometry: 'verticalBars',
  managedRuleKeys: GRAPH_FAMILY_SHARED_STANDARD_KEYS,
  variantAllowedKeys: GRAPH_VARIANT_ALLOWED_KEYS,
  variantForbiddenKeys: GRAPH_VARIANT_FORBIDDEN_KEYS,
  ...
  internalColorMap:
    GRAPH_BAR_WEEKLY_STANDARD_INTERNAL_COLOR_MAP,
  sourceOfTruth: 'GRAPH_BAR_FAMILY_STANDARD',
  canonical: true,
});


export const GRAPH_LINE_FAMILY_STANDARD = Object.freeze({
  version: GRAPH_FAMILY_STANDARD_VERSION,
  family: GRAPH_FAMILIES.LINE,
  referenceGraphId:
    GRAPH_FAMILY_REFERENCE_GRAPH_ID_BY_FAMILY[GRAPH_FAMILIES.LINE],
  ...
  internalColorMap:
    GRAPH_LINE_STANDARD_INTERNAL_COLOR_MAP,
  sourceOfTruth: 'GRAPH_LINE_FAMILY_STANDARD',
  canonical: true,
});

export const GRAPH_INFO_CARD_FAMILY_STANDARD = Object.freeze({
 version: GRAPH_FAMILY_STANDARD_VERSION,
 family: GRAPH_FAMILIES.INFO_CARD,

 // 저장된 기존 byFamily.infoCard 색상 설정을 읽기 위한
 // 호환 식별자일 뿐, 시각 규칙의 source는 아래 canonical 객체이다.
 legacyRenderFamily: GRAPH_RENDER_FAMILIES.INFO_CARD,

 referenceGraphId:
  GRAPH_FAMILY_REFERENCE_GRAPH_ID_BY_FAMILY[GRAPH_FAMILIES.INFO_CARD],
 ...
 sourceOfTruth: 'GRAPH_INFO_CARD_FAMILY_STANDARD',
 canonical: true,
});


export const GRAPH_CALENDAR_FAMILY_STANDARD = Object.freeze({
  version: GRAPH_FAMILY_STANDARD_VERSION,
  family: GRAPH_FAMILIES.CALENDAR,
  referenceGraphId:
    GRAPH_FAMILY_REFERENCE_GRAPH_ID_BY_FAMILY[GRAPH_FAMILIES.CALENDAR],
  geometry: 'monthGrid',
  managedRuleKeys: GRAPH_FAMILY_SHARED_STANDARD_KEYS,
  variantAllowedKeys: GRAPH_VARIANT_ALLOWED_KEYS,
  variantForbiddenKeys: GRAPH_VARIANT_FORBIDDEN_KEYS,
  ...
  internalColorMap:
    GRAPH_CALENDAR_STANDARD_INTERNAL_COLOR_MAP,
  sourceOfTruth: 'GRAPH_CALENDAR_FAMILY_STANDARD',
  canonical: true,
});


export const GRAPH_GRASS_FAMILY_STANDARD = Object.freeze({
  version: GRAPH_FAMILY_STANDARD_VERSION,
  family: GRAPH_FAMILIES.GRASS,
  referenceGraphId:
    GRAPH_FAMILY_REFERENCE_GRAPH_ID_BY_FAMILY[GRAPH_FAMILIES.GRASS],
  ...
  internalColorMap:
    GRAPH_GRASS_STANDARD_INTERNAL_COLOR_MAP,
  sourceOfTruth: 'GRAPH_GRASS_FAMILY_STANDARD',
  canonical: true,
});

export const GRAPH_FAMILY_STANDARDS = Object.freeze({
 [GRAPH_FAMILIES.DONUT]:
  GRAPH_DONUT_FAMILY_STANDARD,

 [GRAPH_FAMILIES.BAR]:
    GRAPH_BAR_FAMILY_STANDARD,

 [GRAPH_FAMILIES.LINE]:
    GRAPH_LINE_FAMILY_STANDARD,

 [GRAPH_FAMILIES.INFO_CARD]:
    GRAPH_INFO_CARD_FAMILY_STANDARD,

 [GRAPH_FAMILIES.CALENDAR]:
    GRAPH_CALENDAR_FAMILY_STANDARD,

 [GRAPH_FAMILIES.GRASS]:
    GRAPH_GRASS_FAMILY_STANDARD,
});
...
export function getGraphRenderInternalColorMap(family) {
  return GRAPH_RENDER_INTERNAL_COLOR_MAP[family] || Object.freeze({});
}
...
export function resolveGraphRenderRule({
  ...
  return Object.freeze({
    ...
    internalColorMap: getGraphRenderInternalColorMap(resolvedFamily),
  });
}
