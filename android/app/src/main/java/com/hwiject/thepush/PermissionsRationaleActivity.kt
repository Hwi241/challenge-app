...
class PermissionsRationaleActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        container.addView(bodyText("더푸시는 사용자가 선택한 기록의 근거를 만들기 위해 Health Connect 데이터를 사용할 수 있습니다."))
        container.addView(bodyText("현재 테스트 단계에서는 걸음 수 읽기 권한만 요청합니다. 더푸시는 이 권한을 사용해 사용자가 직접 선택한 날짜의 걸음 수를 기록 근거로 첨부할 수 있게 할 예정입니다."))
