...
export default function BackupScreen() {
 ...
 <Text style={canonicalTextStyles.bodySmallMuted}>
 JSON을 선택해 데이터를{' '}
 {mode === 'replace' ? '완전히 교체' : 'ID 기준 병합'}합니다.
 </Text>
 ...
 disabled={loading}
 >
 <Text style={buttonStyles.outlineSoft.label}>
 백업 파일 선택
 </Text>
 </TouchableOpacity>
 </View>
